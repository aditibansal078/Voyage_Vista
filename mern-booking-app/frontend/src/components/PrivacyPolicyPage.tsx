  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '20px' }}>
      ...
      <div style={{ fontSize: '16px', lineHeight: '1.6', marginBottom: '20px' }}>
        ...
        <p>
          When you use our hotel reservation system software, we may collect certain personal information, including:
        </p>
        <ul style={{ listStyleType: 'circle', paddingLeft: '20px', marginBottom: '20px' }}>
          ...
          <li>Communications: Any correspondence between you and our customer support team.</li>
        </ul>
      </div>
      <div style={{ fontSize: '16px', lineHeight: '1.6', marginBottom: '20px' }}>
        ...
        <ul style={{ listStyleType: 'circle', paddingLeft: '20px', marginBottom: '20px' }}>
          ...
          <li>Marketing: With your consent, to send you promotional offers, updates, and other marketing communications.</li>
